...
## Proposed Solution
Add a **"Report a problem"** button or link in the app UI (e.g. in the footer or as a floating button). Clicking it would open a pre-filled GitHub new issue URL in a new tab:
